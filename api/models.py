...
class Payment(models.Model):
    ...
    amount = models.DecimalField(max_digits=10, decimal_places=2)  # Fixed typo
...
class Order(models.Model):
    ...
    payment = models.ForeignKey(Payment, on_delete=models.SET_NULL, null=True, blank=True)  # Link payment to order
